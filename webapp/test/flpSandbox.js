		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice List",
									"targetURL": "#aktiveinvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aktiveinvoice-display": {
								"semanticObject": "aktiveinvoice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aktive.invoice",
									"url": sap.ui.require.toUrl("aktive/invoice")
								}
							}
						}
					}
